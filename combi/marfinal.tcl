...
$ns at 0.1 "$udp0 send 500 $sessionstart"
puts "session:$session"
set key [readvalue 1 2]

$ns at 9.0 "$udp0 send 500 sstop"
if {$key!=0} {
puts "key:$key"
package require aes
set fulldata {how are you}
set encryptedData [aes::aes -dir encrypt -key $key $fulldata]
$ns at 8.3 "$udp0 send 500 $encryptedData"
}
