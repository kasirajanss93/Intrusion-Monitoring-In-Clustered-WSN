...
puts "testch4:$ch4"
#puts "key1:$key1"
$ns at 4.1 "$udp($udpval) send 500 $n1:sstart"
...
$ns at 4.3 "$udp($udpval) send 500 $n1:$encryptedData"
$ns at 4.4 "$udp($udpval) send 500 $n1:sstop"
