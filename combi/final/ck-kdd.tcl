...
puts "Monitor"
#check in kdd
#else disable the session
}
Agent/UDP instproc process_data {size data id} {
    global ns
    global udp
    global dbans
    global session
...
puts "testch4:$ch4"
#puts "key1:$key1"
$ns at 4.1 "$udp($udpval) send 500 sstart 0"
...
$ns at 4.3 "$udp($udpval) send 500 $encryptedData 0"
$ns at 4.4 "$udp($udpval) send 500 sstop 0"
