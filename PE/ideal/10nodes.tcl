...
#===============================================================================
proc record {} {
  global node-id1 sink0 sink1 sink2 sink3 sink4 sink5 sink6 sink7 sink8 sink9 f0
...
$ns at 0.0 "$n(9) label RECEIVER_NODE"
...
set cbr2112 [attach-CBR-traffic $n(0) $sink9 800 .03]
